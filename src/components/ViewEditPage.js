...
const ViewEdit = () => {
  useEffect(() => {
    ...
    xhr.addEventListener("load", () => {
      ...
      let data = JSON.parse(temp["view"][0]);
      let category = document.getElementById("category");
      let color = document.getElementById("color");
      let label = document.getElementById("clothing-label");
      if (category && color && label) {
    ...
    xhr.open("POST", "http://localhost:8080/view");
    xhr.send(data);
  }, [])
          ...
          <div id="innerdiv">
            <form id="clothing-form">
              ...
              <div class="clothing-fields">
                ...
                <br />
                <input id="labelinput" type="input" id="clothing-label" required />
              </div>
